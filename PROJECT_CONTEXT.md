...
├── tools.py              # Windows maintenance tools catalogue: 4 categories / 29 tools / 67 modes (PowerShell scripts ported verbatim from `tools source/`, plus v4.11 scan-then-pick cleanup scripts and the v4.19 Disk Rescue engine)
...
- 4 categories, 29 tools, 67 modes total
