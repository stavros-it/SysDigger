...
├── tools.py              # Windows maintenance tools catalogue: 4 categories / 28 tools / 62 modes (PowerShell scripts ported verbatim from `tools source/`, plus v4.11 scan-then-pick cleanup scripts)
...
- 4 categories, 28 tools, 62 modes total
